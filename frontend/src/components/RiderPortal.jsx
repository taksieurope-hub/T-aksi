...
// =============================================================================
// SCHEDULED RIDE MODAL — custom date/time picker (no datetime-local AM/PM bug)
// =============================================================================
...
const [showPromo, setShowPromo] = useState(false);
  ...
  useEffect(() => {
    fetchActiveRide();
    fetchRideHistory();
    // surge fetch removed from mount - only triggers when pickup is set
    fetchScheduledRides();
